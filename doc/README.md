...
| Work with the GitHub API, webhook, or live updates    | [github-integration.md](./github-integration.md)                                  |
...
- **[github-integration.md](./github-integration.md)** — The typed REST client,
  webhook/SSE live updates, auth, error handling, caching, and pagination.
